...
#We need to take a json response and make a csv from it
...
# columns for 'Test Name', 'ID Number', 'Type', 'Status', 'numOfLocations', 'Locations', 'Creator', 'Tags', 'Details'
totalSyntheticTests = len(response['tests'])

def makeCSV():
    fieldnames = ['Test Name', 'ID Number', 'Type', 'Status', 'numOfLocations', 'Locations', 'Creator', 'Tags', 'Details']
    rows = []
    #for test in response['tests']
    for i in range(0, totalSyntheticTests):
