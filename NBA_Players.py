...
# Set next_page to true so the while loop can begin
    ...
    # Check if the request was successful
        if response.status_code == 200:
            try:
                ...
                # Assigns next page to see if we need to iterate again
                next_page = player_data['meta']['next_page']
                # Assigns next page number to call the next page
